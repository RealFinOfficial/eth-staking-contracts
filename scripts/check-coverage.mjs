...
// ── Pinned floors, re-measured 2026-09-15 (the ApeBond round on the guardian-revocation base)
//
// | file                        | lines            | branches        |
// |-----------------------------|------------------|-----------------|
...
// bar: `setGuardian`'s zero check was asserted but its successful rotation was not, so
...
//
// The vault moved in the same round, stacked on the 2026-09-14 guardian-revocation base below:
